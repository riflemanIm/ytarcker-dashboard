...
* **Отметки времени в табличном виде**
  ...
  ![Таблица отметок времени по дням недели](public/images/time-spend-table.png)
...
* **Планирование работ**
  ...
  **«Затраченное время по плану»** для контроля плана, факта и остатка.
  ...
  ![Режим планирования: подбор задач, загрузка сотрудников и план работ](public/images/planning-overview.png)
  ![Затраченное время по плану в разрезе дней](public/images/time-spend-by-plan.png)
