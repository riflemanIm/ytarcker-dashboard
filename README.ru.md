...
Помимо учёта времени, в дашборде реализован режим **планирования**: можно подбирать задачи в план спринта, управлять составом работ, анализировать загрузку сотрудников и контролировать план/факт/остаток.

Также доступна **отчётность**: отдельный режим формирует агрегированный отчёт по периодам (в том числе помесячно по неделям), что помогает оценивать динамику затрат и прозрачность выполнения задач.
...
* **Отметки времени в табличном виде**
  После входа отметки времени отображаются в удобной таблице по дням недели: по каждой задаче видно списания за день и итог за период.

  <img src="https://ytracker.mobimed.ru/time-spend-table.png" alt="Таблица отметок времени по дням недели" />
...
* **Планирование работ**
  В режиме планирования доступны фильтры по спринту, группе, сотруднику, роли и проекту, а также таблицы:
  **«Подбор задач в план»**, **«Загрузка сотрудников»**, **«План работ»** и
  **«Затраченное время по плану»** для контроля плана, факта и остатка.

  <img src="https://ytracker.mobimed.ru/planning-overview.png" alt="Режим планирования: подбор задач, загрузка сотрудников и план работ" />
  <img src="https://ytracker.mobimed.ru/time-spend-by-plan.png" alt="Затраченное время по плану в разрезе дней" />
...
* В **table_time_plan** доступны доп. фильтры (группа, пациент, роль, проект), а также таблицы **Подбор задач в план** и **Загрузка сотрудников**.
  ...
  <img src="https://ytracker.mobimed.ru/planning-overview_is_admin.png" alt="Режим планирования для администратора" />
